...
// PolymorphicFacesRootMetaData contains all meta data concerning the PolymorphicFacesRoot contract.
var PolymorphicFacesRootMetaData = &bind.MetaData{
...
// PolymorphicFacesRootABI is the input ABI used to generate the binding from.
// Deprecated: Use PolymorphicFacesRootMetaData.ABI instead.
var PolymorphicFacesRootABI = PolymorphicFacesRootMetaData.ABI
